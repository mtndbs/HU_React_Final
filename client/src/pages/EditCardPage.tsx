...
function EditCardPage() {
  ...
  React.useEffect(() => {
    ...
    getCardById(id).then((response) => {
      setTitle(response && response.title ? response.title : "");
      setSubTitle(response && response.subTitle ? response.subTitle : "");
      setEmail(response && response.email ? response.email : "");
      setDescription(response && response.description ? response.description : "");
      ...
      setHouseNumber(response && response.houseNumber ? response.houseNumber : "");
    });
  }, [id]);
